...
public class ride_7 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ride_7);

        rsound13 = (Button) findViewById(R.id.rsound13);
        rsound14 = (Button) findViewById(R.id.rsound14);

        rsound13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(ride_7.this,R.raw.motorcyclee);
                mediaPlayer.start();
            }
        });

        rsound14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(ride_7.this,R.raw.motorcyclek);
                mediaPlayer.start();
            }
        });

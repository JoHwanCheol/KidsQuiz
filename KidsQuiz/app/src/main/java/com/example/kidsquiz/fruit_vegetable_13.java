...
public class fruit_vegetable_13 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fruit_vegetable_13);

        vsound25 = (Button) findViewById(R.id.vsound25);
        vsound26 = (Button) findViewById(R.id.vsound26);

        vsound25.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(fruit_vegetable_13.this,R.raw.carrote);
                mediaPlayer.start();
            }
        });

        vsound26.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(fruit_vegetable_13.this,R.raw.carrotk);
                mediaPlayer.start();
            }
        });

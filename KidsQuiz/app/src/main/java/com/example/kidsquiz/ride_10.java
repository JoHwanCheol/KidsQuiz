...
public class ride_10 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ride_10);

        rsound19 = (Button) findViewById(R.id.rsound19);
        rsound20 = (Button) findViewById(R.id.rsound20);

        rsound19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(ride_10.this,R.raw.tractore);
                mediaPlayer.start();
            }
        });

        rsound20.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(ride_10.this,R.raw.tractork);
                mediaPlayer.start();
            }
        });

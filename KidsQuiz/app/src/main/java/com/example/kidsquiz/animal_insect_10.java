...
public class animal_insect_10 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animal_insect_10);

        sound19 = (Button) findViewById(R.id.sound19);
        sound20 = (Button) findViewById(R.id.sound20);

        sound19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(animal_insect_10.this,R.raw.zebrae);
                mediaPlayer.start();
            }
        });

        sound20.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(animal_insect_10.this,R.raw.zebrak);
                mediaPlayer.start();
            }
        });
        if(lang==0) {
            ...
            TextView textview = (TextView) findViewById(R.id.zebra);

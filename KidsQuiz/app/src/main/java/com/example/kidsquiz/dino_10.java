...
public class dino_10 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dino_10);

        dsound19 = (Button) findViewById(R.id.dsound19);
        dsound20 = (Button) findViewById(R.id.dsound20);

        dsound19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(dino_10.this,R.raw.velociraptore);
                mediaPlayer.start();
            }
        });

        dsound20.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(dino_10.this,R.raw.velociraptork);
                mediaPlayer.start();
            }
        });
    ...
    public void velociraptor(View v){

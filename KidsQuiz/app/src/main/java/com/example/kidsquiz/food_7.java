...
public class food_7 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_7);

        fsound13 = (Button) findViewById(R.id.fsound13);
        fsound14 = (Button) findViewById(R.id.fsound14);

        fsound13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(food_7.this,R.raw.juicee);
                mediaPlayer.start();
            }
        });

        fsound14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(food_7.this,R.raw.juicek);
                mediaPlayer.start();
            }
        });

...
public class food_3 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_3);

        fsound5 = (Button) findViewById(R.id.fsound5);
        fsound6 = (Button) findViewById(R.id.fsound6);

        fsound5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(food_3.this,R.raw.coffeee);
                mediaPlayer.start();
            }
        });

        fsound6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(food_3.this,R.raw.coffeek);
                mediaPlayer.start();
            }
        });

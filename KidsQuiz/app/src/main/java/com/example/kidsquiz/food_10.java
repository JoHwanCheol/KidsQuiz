...
public class food_10 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_10);

        fsound19 = (Button) findViewById(R.id.fsound19);
        fsound20 = (Button) findViewById(R.id.fsound20);

        fsound19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(food_10.this,R.raw.porkcutlete);
                mediaPlayer.start();
            }
        });

        fsound20.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(food_10.this,R.raw.porkcutletk);
                mediaPlayer.start();
            }
        });

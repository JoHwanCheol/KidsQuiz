...
public class animal_insect_2 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animal_insect_2);
        ...
        sound3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(animal_insect_2.this,R.raw.cate);
                mediaPlayer.start();
            }
        });
        ...
        sound4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(animal_insect_2.this,R.raw.catk);
                mediaPlayer.start();
            }
        });

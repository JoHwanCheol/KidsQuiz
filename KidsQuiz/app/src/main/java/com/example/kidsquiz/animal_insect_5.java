...
public class animal_insect_5 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animal_insect_5);
        ...
        sound9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(animal_insect_5.this,R.raw.giraffee);
                mediaPlayer.start();
            }
        });

        sound10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(animal_insect_5.this,R.raw.giraffek);
                mediaPlayer.start();
            }
        });

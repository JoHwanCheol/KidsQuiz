...
public class animal_insect_4 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animal_insect_4);
        ...
        sound7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(animal_insect_4.this,R.raw.foxe);
                mediaPlayer.start();
            }
        });
        ...
        sound8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(animal_insect_4.this,R.raw.foxk);
                mediaPlayer.start();
            }
        });
        ...
        if(lang==0) {
            ...
            TextView textview = (TextView) findViewById(R.id.fox);

...
public class animal_insect_8 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animal_insect_8);

        sound15 = (Button) findViewById(R.id.sound15);
        sound16 = (Button) findViewById(R.id.sound16);

        sound15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(animal_insect_8.this,R.raw.rabbite);
                mediaPlayer.start();
            }
        });

        sound16.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(animal_insect_8.this,R.raw.rabbitk);
                mediaPlayer.start();
            }
        });
        ...
        if(lang==0) {
            ...
            TextView textview = (TextView) findViewById(R.id.rabbit);
            ...
            textview.setText(name_animal[16]);
            textview1.setText(name_animal[a]);
            textview2.setText(name_animal[b]);
        }
    }

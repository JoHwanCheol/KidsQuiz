...
public class fruit_vegetable_8 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fruit_vegetable_8);

        vsound15 = (Button) findViewById(R.id.vsound15);
        vsound16 = (Button) findViewById(R.id.vsound16);

        vsound15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(fruit_vegetable_8.this,R.raw.pineapplee);
                mediaPlayer.start();
            }
        });

        vsound16.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(fruit_vegetable_8.this,R.raw.pineapplek);
                mediaPlayer.start();
            }
        });

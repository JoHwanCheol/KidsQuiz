...
public class dino_7 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dino_7);

        dsound13 = (Button) findViewById(R.id.dsound13);
        dsound14 = (Button) findViewById(R.id.dsound14);

        dsound13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(dino_7.this,R.raw.stegosauruse);
                mediaPlayer.start();
            }
        });

        dsound14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(dino_7.this,R.raw.stegosaurusk);
                mediaPlayer.start();
            }
        });
    ...
    public void stegosaurus(View v){

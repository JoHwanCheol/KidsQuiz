...
public class ride_6 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ride_6);

        rsound11 = (Button) findViewById(R.id.rsound11);
        rsound12 = (Button) findViewById(R.id.rsound12);

        rsound11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(ride_6.this,R.raw.kickboarde);
                mediaPlayer.start();
            }
        });

        rsound12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(ride_6.this,R.raw.kickboardk);
                mediaPlayer.start();
            }
        });

...
public class ride_3 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ride_3);

        rsound5 = (Button) findViewById(R.id.rsound5);
        rsound6 = (Button) findViewById(R.id.rsound6);

        rsound5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(ride_3.this,R.raw.boate);
                mediaPlayer.start();
            }
        });

        rsound6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(ride_3.this,R.raw.boatk);
                mediaPlayer.start();
            }
        });

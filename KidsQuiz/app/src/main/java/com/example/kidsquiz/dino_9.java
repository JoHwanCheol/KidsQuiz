...
public class dino_9 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dino_9);

        dsound17 = (Button) findViewById(R.id.dsound17);
        dsound18 = (Button) findViewById(R.id.dsound18);

        dsound17.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(dino_9.this,R.raw.tyrannosauruse);
                mediaPlayer.start();
            }
        });

        dsound18.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(dino_9.this,R.raw.tyrannosaurusk);
                mediaPlayer.start();
            }
        });
    ...
    public void tyrannosaurus(View v){

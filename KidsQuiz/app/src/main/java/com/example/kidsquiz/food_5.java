...
public class food_5 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_5);

        fsound9 = (Button) findViewById(R.id.fsound9);
        fsound10 = (Button) findViewById(R.id.fsound10);

        fsound9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(food_5.this,R.raw.frenchfriese);
                mediaPlayer.start();
            }
        });

        fsound10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(food_5.this,R.raw.frenchfriesk);
                mediaPlayer.start();
            }
        });
    ...
    public void frenchfries(View v){

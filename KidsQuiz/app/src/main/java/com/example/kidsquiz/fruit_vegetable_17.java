...
public class fruit_vegetable_17 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fruit_vegetable_17);

        vsound33 = (Button) findViewById(R.id.vsound33);
        vsound34 = (Button) findViewById(R.id.vsound34);

        vsound33.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(fruit_vegetable_17.this,R.raw.onione);
                mediaPlayer.start();
            }
        });

        vsound34.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(fruit_vegetable_17.this,R.raw.onionk);
                mediaPlayer.start();
            }
        });
        ...
        if(lang==0) {
            ...
            TextView textview = (TextView) findViewById(R.id.onion);

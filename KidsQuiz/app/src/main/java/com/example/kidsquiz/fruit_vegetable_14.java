...
public class fruit_vegetable_14 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fruit_vegetable_14);

        vsound27 = (Button) findViewById(R.id.vsound27);
        vsound28 = (Button) findViewById(R.id.vsound28);

        vsound27.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(fruit_vegetable_14.this,R.raw.cucumbere);
                mediaPlayer.start();
            }
        });

        vsound28.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(fruit_vegetable_14.this,R.raw.cucumberk);
                mediaPlayer.start();
            }
        });
        ...
        if(lang==0) {
            ...
            TextView textview = (TextView) findViewById(R.id.cucumber);

...
public class food_9 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_9);

        fsound17 = (Button) findViewById(R.id.fsound17);
        fsound18 = (Button) findViewById(R.id.fsound18);

        fsound17.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(food_9.this,R.raw.pizzae);
                mediaPlayer.start();
            }
        });

        fsound18.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(food_9.this,R.raw.pizzak);
                mediaPlayer.start();
            }
        });

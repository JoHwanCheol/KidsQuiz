...
public class fruit_vegetable_12 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fruit_vegetable_12);

        vsound23 = (Button) findViewById(R.id.vsound23);
        vsound24 = (Button) findViewById(R.id.vsound24);

        vsound23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(fruit_vegetable_12.this,R.raw.cabbagee);
                mediaPlayer.start();
            }
        });

        vsound24.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // MediaPlayer 객체 할당
                mediaPlayer = MediaPlayer.create(fruit_vegetable_12.this,R.raw.cabbagek);
                mediaPlayer.start();
            }
        });
